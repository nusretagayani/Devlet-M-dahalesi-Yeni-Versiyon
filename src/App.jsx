...
export default function EconomicsSimulator() {
  ...
  if (intervention === "ceiling" && interventionValue < eq.p) {
    ...
    actualQ =
      ((90 - tax) * supplyFactor * demandFactor) /
      (2 * demandFactor + 2 * supplyFactor);
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-gray-50">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">
        Devlet Müdahalesi Ekonomi Simülatörü - İktisat Öğrencileri
      </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <h2 className="text-xl font-semibold mb-4 text-gray-700">alesi</h2>
          <select
            value={intervention}
          ...
          {intervention !== "none" && (
            <>
              <label className="block text-sm font-medium mb-2 text-gray-600">
                {intervention === "tax" ? "Vergi Miktarı" : "Fiyat"}: ₺
                {interventionValue}
              </label>
              <input
                type="range"
      ...
      <div className="bg-white p-6 rounded-lg shadow mb-6">
        ...
        >
          ...
          <YAxis
            label={{ value: "Fiyat (₺)", angle: -90, position: "left" }}
            domain={[0, 110]}
          />
        ...
        {dwl > 0 && (
          <div className="bg-red-50 p-4 rounded-lg border-2 border-red-300 md:col-span-2">
            ...
            <p className="text-xs text-red-600 mt-1">
              Kırmızı alan müdahaleden kaynaklanan ekonomik verimsizliği
              gösterir
            </p>
          </div>
        )}
      ...
      <div className="mt-6 bg-white p-6 rounded-lg shadow">
        ...
        <ul className="space-y-2 text-sm text-gray-700">
          <li>
            <strong>Arz Artışı:</strong> Arz eğrisini sağa kaydırır → Fiyat
            düşer → Üretici fazlası azalır, Tüketici fazlası artar
          </li>
          <li>
            <strong>Talep Artışı:</strong> Talep eğrisini sağa kaydırır → Fiyat
            yükselir → Üretici fazlası artar, Tüketici fazlası azalır
          </li>
          <li>
            <strong>Tavan Fiyat:</strong> Dengenin altında maksimum yasal fiyat
            → Kıtlık → Ölü ağırlık kaybı (kırmızı alan)
          </li>
          <li>
            <strong>Taban Fiyat:</strong> Dengenin üstünde minimum yasal fiyat →
            Arz fazlası → Ölü ağırlık kaybı (kırmızı alan)
          </li>
          <li>
            <strong>Vergi:</strong> Alıcı ve satıcı fiyatı arasında fark →
            Azalan miktar → Ölü ağırlık kaybı (kırmızı alan)
          </li>
        </ul>
      </div>
    </div>
